...
>
> **Detail diela & profily umelcov 10.5.2026 (Phase 2):** Detail diela prepracovaný — obrázok bez overlay badge-ov, **príbeh predchádza komerciu**, cena/CTA až pod scrollom v minimalistickom „commerce panel" bez boxov. Drop countdown stíšený do inline riadku. „Co k tomu dostaneš" emoji-list nahradený 3-riadkovým small-caps listom. Zoznam umelcov teraz **vedie dielami** — 4 práce v rade, biografia až pod nimi. Profil umelca: pokojný hero bez gradientu, žiadne metadata-clutter, FollowButton ako tichý link s podčiarknutím. BuyButton zo zlatočervenej gradient pilulky na flat cream block s tracking typom; gamifikačné odmeny presunuté zo predaja na success page (prekvapenie po kúpe, nie predajný argument). WishlistButton ako "Uložiť" / "✓ Uložené" textový link.
...
| | |
|---|---|
| **URL** | https://oknoduse-hyfc.vercel.app |
| **Status** | ✅ Ready (nasadený) |
| **Platform** | Vercel |
| **Domain** | oknoduse-hyfc.vercel.app |
| **Repository** | https://github.com/manadominik-hash/oknoduse |
| **Branch** | main |
| **Created** | 10.5.2026 (4 min after spec completion) |
| **Edge Requests** | 89 |
...
- **Repository:** [manadominik-hash/oknoduse](https://github.com/manadominik-hash/oknoduse)
- **Tech Stack:** Next.js 16, React 19, TypeScript, Tailwind CSS v4, Framer Motion
- **Hosting:** Vercel (AI Cloud)
- **Status:** ✅ Live & Ready
